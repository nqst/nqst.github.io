...
Нещодавно оновив собі робочий MacBook. За моїм попереднім ноутбуком 2017 року було вже важко щоденно працювати через слабку батарею та западаючі клавіші на клавіатурі.

Нову техніку мені подобається налаштовувати з чистого аркушу. Це чудовий привід зробити щось по-новому та дізнатися щось цікаве. Цього разу я занотовував свої налаштування — хочу поділитися деякими з них.
...
#### Input sources
- **Налаштовую перемикання розкладки по Caps Lock:** Use the Caps Lock key to switch to and from ABC. Корисна і зручна фіча, щоб перемикати мову однією клавішею. На жаль, іноді не спрацьовує і трохи глючить.
...
## Dock
- **Видалив більшість стандартних застосунків.** Залишив Finder, Safari і Календар.
...
- У терміналі роблю так, щоб док приховувався і зʼявлявся швидше і без затримки:
...
<figure class="figure--screenshot">
  <img src="/i/blog/macos-setup/finder.png" style="border-radius: 12px;" alt="Finder">
</figure>
...
Здається, це усі основні налаштування. Залишилось вручну налаштувати клавіатурну розкладку: у стандартній українській розкладці мені не вистачає більш зручного доступу до лапок `«»`, тире `—`, слешу `/` та деяких інших символів. Але це вже окрема історія.
