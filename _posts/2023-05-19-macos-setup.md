...
Мені подобається налаштовувати нову техніку з чистого аркушу. Це чудовий привід зробити щось по-новому та дізнатися щось цікаве. Цього разу я занотовував свої налаштування — хочу поділитися деякими з них.
...
При початкових налаштуваннях, які пропонує система при першому запуску компʼютера, вимикаю Siri і вмикаю FileVault. FileVault постійно шифрує всі дані на диску, і без пароля ані у кого не буде до них доступу — дуже важлива фіча, особливо коли у вас ноутбук.
...
## Safari
- **View: Show Status bar** (`⌘/`).
- **Settings › General › Safari opens with: All non-private windows from last session** — щоб губити відкриті таби.
...
Момент, якого я завжди чекаю при налаштуванні нового компʼютера, — встановлення програм через Homebrew Cask. Цей інструмент дозволяє ввести назви потрібних програм у комадному рядку, і він всі їх установить. Це економить неймовірну кількість часу і енергії.
