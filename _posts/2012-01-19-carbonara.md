...
<figure class="wide intro">
	<img src="/i/carbonara/carbonara.jpg" alt="Карбонара">
</figure>

Pasta alla Carbonara — традиционная итальянская паста, одна из самых популярных в мире. В неё добавляют бекон, яйца, сыр и чёрный перец.
